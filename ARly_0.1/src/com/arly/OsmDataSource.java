...
public class OsmDataSource extends NetworkDataSource {
    private static final String BASE_URL = "http://api.geonames.org/findNearbyPOIsOSMJSON";
    ...
    protected void createIcon(Resources res) {
        ...
        icon=BitmapFactory.decodeResource(res, R.drawable.osm);
    }
    ...
    public List<AR_Object> parse(JSONObject root) {
        ...
        try {
            if(root.has("poi")) dataArray = root.getJSONArray("poi");
